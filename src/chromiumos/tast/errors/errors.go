...
// standard libraries (errors.New, fmt.Errorf) or any other third-party libraries.
// This package records stack traces and chained errors, and leaves nicely formatted
...
//
// Stack trace can be printed by passing an error to error reporting methods in
// testing.State, or formatting it with fmt package with "%+v" verb.
package errors
