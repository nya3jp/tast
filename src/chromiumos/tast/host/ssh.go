...
//
// DEPRECATED: please use ssh.SymlinkPolicy instead.
type SymlinkPolicy int

const (
	// PreserveSymlinks indicates that symlinks should be preserved during the copy.
	//
	// DEPRECATED: please use ssh.PreserveSymlinks instead.
	...
	//
	// DEPRECATED: please use ssh.DereferenceSymlinks instead.
	DereferenceSymlinks
)
