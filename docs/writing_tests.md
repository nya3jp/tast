...
It's forbidden for `chromiumos/tast/remote/...` packages to import `chromiumos/tast/local/...` packages and vice verse. If local and remote packages should share the same code, put them in `chromiumos/tast/common/...`.
