...
`
	...
	issues := VerifyInformationalAttr(fs, f)
	expects := []string{
		path + ":5:3: Newly added tests should be marked as 'informational'.",
	}
	verifyIssues(t, issues, expects)
}
...
`
	...
	issues := VerifyInformationalAttr(fs, f)
	expects := []string{
		path + ":10:9: Newly added tests should be marked as 'informational'.",
		path + ":13:9: Newly added tests should be marked as 'informational'.",
	}
	verifyIssues(t, issues, expects)
}
...
`
	...
	issues := VerifyInformationalAttr(fs, f)
	expects := []string{
		path + ":6:9: Newly added tests should be marked as 'informational'.",
		path + ":9:9: Newly added tests should be marked as 'informational'.",
	}
	verifyIssues(t, issues, expects)
}
