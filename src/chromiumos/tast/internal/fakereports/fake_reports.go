...
// LogStream provides a mean for reports clients to test LogStream requests.
...
// ReportResult provides a mean for reports clients to test ReportResult requests.
