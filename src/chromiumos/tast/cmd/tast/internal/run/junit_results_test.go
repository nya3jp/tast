...
func TestWriteJUnitResults(t *gotesting.T) {
	...
	results := []*EntityResult{
		&EntityResult{
			...
			Errors:     []EntityError{},
			Start:      time.Date(2021, 2, 3, 19, 00, 02, 0, jst),
			End:        time.Date(2021, 2, 3, 19, 00, 03, 0, jst),
		...
		&EntityResult{
			...
			Errors:     []EntityError{},
			Start:      time.Date(2021, 2, 3, 19, 00, 03, 0, jst),
			End:        time.Date(2021, 2, 3, 19, 00, 05, 0, jst),
			...
			Errors: []EntityError{
				{
					...
					Time: time.Date(2021, 2, 3, 19, 0, 10, 0, jst),
				},
			},
			Start: time.Date(2021, 2, 3, 19, 0, 7, 0, jst),
			// Start time.Time `json:"start"`
			End:        time.Date(2021, 2, 3, 19, 0, 10, 0.5e9, jst),
