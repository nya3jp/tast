...
func processExternalDataLinks(ctx context.Context, dataDir, artifactsURL string, tests []*testing.RunnableTest, cl devserver.Client, lf func(msg string)) {
...
func prepareDownloads(dataDir, artifactsURL string, tests []*testing.RunnableTest, lf func(msg string)) []*downloadJob {
