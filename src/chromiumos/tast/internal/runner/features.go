...
func findArmSOC(parsed *lscpuResult) (device.Config_SOC, error) {
	...
	case "4":
		...
		if !ok {
			return device.Config_SOC_UNSPECIFIED, errors.Errorf("unknown number of cores")
		}
		switch cpus {
		case "8":
