...
have public tests accesing them.

To explain how to do it, let `foo.Bar` be a test need access to secret username and password.
...
Secret variables cannot define global variables.
...
Voilations of the naming convention will cause linter or runtime errors.
