...
// Deps exposes hwdep.Deps. Please find its document for details.
type Deps = hwdep.Deps

// Condition exposes hwdep.Condition. Please find its document for details.
type Condition = hwdep.Condition

// D proxies to hwdep.D. Please find its document for details.
