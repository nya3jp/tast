...
func Wifi80211ax() Condition {
	...
	// TODO(crbug.com/1070299): replace this when we have hwdep for WiFi chips.
	c := SkipOnPlatform("asuka", "asurada", "atlas", "auron_paine", "auron_yuna", "banjo", "banon", "bob", "buddy", "candy", "caroline", "cave", "celes", "chell", "coral", "cyan", "dedede", "drallion", "edgar", "elm", "enguarde", "eve", "fizz", "gale", "gandof", "gnawty", "grunt", "guado", "hana", "hatch", "jacuzzi", "kalista", "kefka", "kevin", "kevin64", "kip", "kukui", "lars", "lulu", "nami", "nautilus", "ninja", "nocturne", "octopus", "orco", "puff", "pyro", "rammus", "reef", "reks", "relm", "rikku", "samus", "sand", "sarien", "scarlet", "sentry", "setzer", "snappy", "soraka", "sumo", "swanky", "terra", "tidus", "trogdor", "ultima", "volteer", "winky", "wizpig", "zork")
