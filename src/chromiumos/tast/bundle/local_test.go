...
func TestLocalRunTest(t *gotesting.T) {
	...
	restore := testing.SetGlobalRegistryForTesting(testing.NewRegistry())
	defer restore()
	testing.AddRunnableTest(&testing.RunnableTest{Name: name, Func: func(context.Context, *testing.State) { ran = true }})
...
func TestLocalPreTestRun(t *gotesting.T) {
	...
	restore := testing.SetGlobalRegistryForTesting(testing.NewRegistry())
	defer restore()
	testing.AddRunnableTest(&testing.RunnableTest{Name: name, Func: func(context.Context, *testing.State) {}})
