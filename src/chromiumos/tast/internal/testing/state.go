...
// NewContextWithGlobalVarContraints creates a new context with additional constraints to the current one.
func NewContextWithGlobalVarContraints(ctx context.Context, allVars map[string]interface{}) context.Context {
	return testcontext.NewContextWithGlobalVarContraints(ctx, allVars)
}
