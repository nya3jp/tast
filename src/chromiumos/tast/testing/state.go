...
//
// Since State contains many data, passing it to a function makes it obscure
// what are inputs. You should keep State in the test functions only; instead
// you can pass to other functions State's derived values
// (e.g. s.DataPath("file.txt")) or ctx (to use with ContextLog or ContextOutDir
// etc.).
//
