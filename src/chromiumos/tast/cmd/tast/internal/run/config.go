...
func (c *Config) SetFlags(f *flag.FlagSet) {
	...
	f.StringVar(&c.originalDevServersStr, "devservers", "", "comma-separated list of devserver URLs")
	if c.originalDevServersStr != "" {
		c.devservers = strings.Split(c.originalDevServersStr, ",")
	}
