...
*   `crash_selinux_stable` - crash reporter components that rely selinux going to journald are stable
*   `crash_selinux_unstable` - crash reporter components that rely selinux going to journald are unstable
