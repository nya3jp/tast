...
./update_chroot          # makes sure that you the latest dependencies installed
```
...
3.  Setup code navigation (`F12` key):

    1.  Update the `GOPATH` environment variable.
    ...
    2.  Install missing dependencies
        ...
        ```sh
        go get -v github.com/mafredri/cdp
        go get -v github.com/shirou/gopsutil/process
