...
`,
	...
	},
	{
		...
		Subattrs: []*attr{
			{
				Name: "cellular_stable",
				Desc: `Identifies Cellular tests that are stable, for running on stable suites and/or the CQ.`,
			},
		},
	},
	{
		Name:     "cellular_esim",
		Contacts: []string{"chromeos-cellular-team@google.com"},
		Desc:     `Identifies Cellular tests to be run on hardware with a builtin Cellular modem with an eSIM card and a pSIM card.`,
		Subattrs: []*attr{
			{
				Name: "cellular_esim_stable",
				Desc: `Identifies Cellular esim tests that are stable, for running on stable suites and/or the CQ.`,
			},
		},
	},
	{
