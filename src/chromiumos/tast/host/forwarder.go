...
//
// If non-nil, errFunc will be invoked asynchronously on a goroutine with connection
// or forwarding errors.
func NewForwarder(ssh *SSH, localAddr, remoteAddr string, errFunc func(error)) (*Forwarder, error) {
	f := Forwarder{
