...
type OutputStream interface {
	...
	// ReportScreenshot reports that a screenshot has been taken to send for skia for diff testing.
...
// ReportScreenshot reports that a screenshot has been taken to send for skia for diff testing.
func (s *globalMixin) ReportScreenshot(name string, screenshot *image.RGBA, keyValueMap map[string]string) error {
	return s.entityRoot.out.ReportScreenshot(name, screenshot, keyValueMap)
}
