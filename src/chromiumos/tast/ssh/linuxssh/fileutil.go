...
// ReadFile reads the file on the path and reutrns the contents.
...
// WriteFile writes data to a file on the path. If the file does
// not exist, WriteFile creates it with the default permissions;
