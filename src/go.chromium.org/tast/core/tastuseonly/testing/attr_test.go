...
func TestCheckKnownAttrs(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			attrs: []string{""},
			error: `attribute "" is invalid in current groups; see go.chromium.org/tast/core/tastuseonly/testing/attr.go for the full list of valid attributes`,
		},
		{
			attrs: []string{"informational"},
			error: `attribute "informational" is invalid in current groups; see go.chromium.org/tast/core/tastuseonly/testing/attr.go for the full list of valid attributes`,
		},
		{
		...
		{
			attrs: []string{"foo"},
			error: `attribute "foo" is invalid in current groups; see go.chromium.org/tast/core/tastuseonly/testing/attr.go for the full list of valid attributes`,
		},
		{
			attrs: []string{"foo:bar"},
			error: `attribute "foo:bar" is invalid in current groups; see go.chromium.org/tast/core/tastuseonly/testing/attr.go for the full list of valid attributes`,
		},
		{
		...
		},
		{
			...
			error: `group "foo" is invalid; see go.chromium.org/tast/core/tastuseonly/testing/attr.go for the full list of valid groups`,
		},
		{
