...
// Package stack provides an utility to capture and format a stack trace.
// This is not intended to be used directly by Tast tests; use errors package instead.
package stack
