...
// testDepsMode describes how individual tests' dependencies should be checked against software
...
type Config struct {
	...
	checkTestDeps               testDepsMode // whether test dependencies should be checked
