...
func TestWriteJUnitXMLResults(t *gotesting.T) {
			...
			Errors: []resultsjson.Error{
				{
					...
					File:   "/home/user/trunk/src/platform/tast/src/go.chromium.org/tast/core/internal/planner/run.go",
					Line:   829,
  ...
  <testsuite tests="3" failures="1" skipped="1">
    ...
    <testcase name="example.Fail" status="run" result="completed" timestamp="2021-02-03T10:00:07Z" time="3.5">
      <failure message="unknown SoftwareDeps: android"><![CDATA[/home/user/trunk/src/platform/tast/src/go.chromium.org/tast/core/internal/planner/run.go:829
]]></failure>
    </testcase>
  </testsuite>
</testsuites>`, "\n")
