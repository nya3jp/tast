...
func TestReadTestOutput(t *gotesting.T) {
	...
	mw.WriteMessage(&control.TestStart{Time: test1StartTime, Test: testing.RunnableTest{Name: test1Name, Desc: test1Desc}})
	...
	mw.WriteMessage(&control.TestStart{Time: test2StartTime, Test: testing.RunnableTest{Name: test2Name, Desc: test2Desc}})
	...
	mw.WriteMessage(&control.TestStart{Time: test3StartTime, Test: testing.RunnableTest{Name: test3Name, Desc: test3Desc}})
	...
	expRes := []TestResult{
		{
			RunnableTest: testing.RunnableTest{Name: test1Name, Desc: test1Desc},
			Start:        test1StartTime,
			End:          test1EndTime,
			OutDir:       filepath.Join(cfg.ResDir, testLogsDir, test1Name),
		},
		{
			RunnableTest: testing.RunnableTest{Name: test2Name, Desc: test2Desc},
			Errors: []TestError{
				{
					Time: test2ErrorTime,
					Error: testing.Error{
		...
		{
			RunnableTest: testing.RunnableTest{Name: test3Name, Desc: test3Desc},
...
func TestReadTestOutputTimingLog(t *gotesting.T) {
	...
	mw.WriteMessage(&control.TestStart{Time: time.Unix(2, 0), Test: testing.RunnableTest{Name: testName1}})
	mw.WriteMessage(&control.TestEnd{Time: time.Unix(3, 0), Name: testName1, TimingLog: testLog1})
	mw.WriteMessage(&control.TestStart{Time: time.Unix(4, 0), Test: testing.RunnableTest{Name: testName2}})
...
func TestPerTestLogContainsRunError(t *gotesting.T) {
	...
	mw.WriteMessage(&control.TestStart{Time: time.Unix(2, 0), Test: testing.RunnableTest{Name: testName}})
...
func TestValidateMessages(t *gotesting.T) {
	...
	for _, tc := range []struct {
		...
		{"unfinished test", []string{"test1", "test2"}, []interface{}{
			...
			&control.TestStart{Time: time.Unix(2, 0), Test: testing.RunnableTest{Name: "test1"}},
			&control.TestEnd{Time: time.Unix(3, 0), Name: "test1"},
			&control.TestStart{Time: time.Unix(4, 0), Test: testing.RunnableTest{Name: "test2"}},
			&control.RunEnd{Time: time.Unix(5, 0), OutDir: ""},
		}},
		{"TestStart before RunStart", nil, []interface{}{
			&control.TestStart{Time: time.Unix(1, 0), Test: testing.RunnableTest{Name: "test1"}},
		...
		{"no TestEnd", []string{"test1"}, []interface{}{
			&control.RunStart{Time: time.Unix(1, 0), TestNames: []string{"test1", "test2"}},
			&control.TestStart{Time: time.Unix(2, 0), Test: testing.RunnableTest{Name: "test1"}},
			&control.TestStart{Time: time.Unix(3, 0), Test: testing.RunnableTest{Name: "test2"}},
		...
		{"TestStart with already-seen name", []string{"test1"}, []interface{}{
			...
			&control.TestStart{Time: time.Unix(2, 0), Test: testing.RunnableTest{Name: "test1"}},
			&control.TestEnd{Time: time.Unix(3, 0), Name: "test1"},
			&control.TestStart{Time: time.Unix(4, 0), Test: testing.RunnableTest{Name: "test1"}},
...
func TestWritePartialResults(t *gotesting.T) {
	...
	mw.WriteMessage(&control.TestStart{Time: test1Start, Test: testing.RunnableTest{Name: test1Name}})
	mw.WriteMessage(&control.TestEnd{Time: test1End, Name: test1Name})
	mw.WriteMessage(&control.TestStart{Time: test2Start, Test: testing.RunnableTest{Name: test2Name}})
	...
	expRes := []TestResult{
		{
			RunnableTest: testing.RunnableTest{Name: test1Name},
			Start:        test1Start,
			End:          test1End,
			OutDir:       filepath.Join(cfg.ResDir, testLogsDir, test1Name),
		},
		...
		{
			RunnableTest: testing.RunnableTest{Name: test2Name},
			Start:        test2Start,
			Errors: []TestError{
	...
	mw.WriteMessage(&control.TestStart{Time: test4Start, Test: testing.RunnableTest{Name: test4Name}})
	...
	expRes = append(expRes, TestResult{
		RunnableTest: testing.RunnableTest{Name: test4Name},
		Start:        test4Start,
		End:          test4End,
...
func TestUnfinishedTest(t *gotesting.T) {
	...
	for i, tc := range []struct {
		...
		mw.WriteMessage(&control.TestStart{Time: tm, Test: testing.RunnableTest{Name: testName}})
		if tc.writeTestErr {
...
func TestWriteResultsUnmatchedGlobs(t *gotesting.T) {
	...
	results := []TestResult{
		TestResult{RunnableTest: testing.RunnableTest{Name: "pkg.Test1"}},
		TestResult{RunnableTest: testing.RunnableTest{Name: "pkg.Test2"}},
	}
