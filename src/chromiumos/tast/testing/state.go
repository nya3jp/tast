...
type State struct {
	...
	preData interface{} // data returned by test.Pre.Prepare; may be nil
...
// Pre returns an object supplied by the test's precondition, which must have been declared via Test.Pre
...
func (s *State) Pre() interface{} { return s.preData }
