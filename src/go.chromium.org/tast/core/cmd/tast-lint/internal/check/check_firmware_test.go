...
func TestFirmwareParams(t *testing.T) {
	...
	testing.AddTest(&testing.Test{
		...
		Contacts: []string{"me@chromium.org"},
		BugComponent: "b:1034625",
		Attr: []string{"group:firmware", "firmware_ec_stressed"},
		Params: []Param{{
			Name: "param1",
			ExtraAttr: []string{"firmware_ec_meets_kpi"},
		}, {
			Name: "param2",
			ExtraAttr: []string{"firmware_ec_enabled"},
		}},
	})`, []string{fwTestPath + ":15:4: " + fmt.Sprintf(missingGateAttr, "firmware_ec_enabled", "firmware_ec_meets_kpi")}},
	...
	testing.AddTest(&testing.Test{
		...
		Params: []Param{{
			...
			Name: "param2",
			ExtraAttr: []string{"firmware_ec_enabled", "firmware_ec_meets_kpi"},
		}},
	})`, nil},
	} {
