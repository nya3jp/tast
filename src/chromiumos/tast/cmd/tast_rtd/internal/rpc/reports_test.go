...
func TestReportsServer_LogStream(t *testing.T) {
	const (
		...
		logSinkName1 = "/tmp/tast/results/latest/tests/name01-20210123/test.Name1/log.txt"
		requestName1 = "request_for_test_name1"
		testLog1a    = "log1a"
		testLog1b    = "log1b"
		testName2    = "test.Name2"
		requestName2 = "request_for_test_name2"
		logSinkName2 = "/tmp/tast/results/latest/tests/name01-20210123/test.Name1/log.txt"
		testLog2a    = "log2a"
	)
