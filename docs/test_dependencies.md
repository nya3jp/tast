...
* `arc_print_stable` Boards that can run Android printing tests without flakes.
...
* `csme_update` - Intel boards with updateable CSME firmware (volteer/dedede
  onwards)
* `cups` - CUPS daemon.
...
* `npu` - Availability of NPU and its related software components to run AI models.
