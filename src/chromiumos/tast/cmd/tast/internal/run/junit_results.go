...
type TestSuite struct {
	...
	TestCase  []*TestCase `xml:"testcase,omitempty"`
...
type TestCase struct {
	...
	Timestamp string `xml:"timestamp,attr,omitempty"` // start time, in ISO8601
	Time      string `xml:"time,attr,omitempty"`      // duration
