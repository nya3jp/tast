...
`
	expects := []string{
		"src/chromiumos/tast/local/testfile.go:4:2: Local package should not import remote package chromiumos/tast/remote/foo",
	}
...
`
	expects := []string{
		"src/chromiumos/tast/remote/testfile.go:4:2: Remote package should not import local package chromiumos/tast/local/foo",
	}
