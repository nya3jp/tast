...
import (
	...
	"go.chromium.org/tast/core/cmd/tast/internal/run/runtest/internal/fakerunner"
...
func SetUp(t *gotesting.T, opts ...EnvOrDUTOption) *Env {
	...
	// before os.MkdirTemp is called. Call os.MkdirAll to make sure the
	// temp directory exists.
	os.MkdirAll(os.TempDir(), 0777)
	rootDir, err := os.MkdirTemp("", "tast.")
	if err != nil {
		t.Fatal(err)
	}
