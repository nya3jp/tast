...
It is fine to return an error without wrapping, if you can't really add much context. Use your best judge to decide wrap or not.
Following quotes from *[The Go programming language] 5.4.1 Error-Handling Strategies* will be useful to design good error message.
