...
func main() {
	...
	scfg := runner.StaticConfig{
		...
		SoftwareFeatureDefinitions: map[string]string{
			...
			"crossystem":        "!betty && !reven && !tast_vm", // VMs don't support few crossystem sub-commands: https://crbug.com/974615
			"cups":              "cups",
			"diagnostics":       "diagnostics && !betty && !reven && !tast_vm", // VMs do not have hardware to diagnose. https://crbug.com/1126619
			...
			"endorsement":             "!betty && !reven && !tast_vm", // VMs don't have valid endorsement certificate.
			"firewall":                "!moblab",                      // Moblab has relaxed iptables rules
			"flashrom":                "!betty && !reven && !tast_vm",
			...
			"gpu_sandboxing":          "!betty && !reven && !tast_vm",           // no GPU sandboxing on VMs: https://crbug.com/914688
			...
			"lacros_stable":           "!arm && !arm64 && !tast_vm && !betty && !reven", // TODO(b/183969803): Remove this.
			"lacros_unstable":         "!arm && !arm64 && (tast_vm || betty || reven)",  // TODO(b/183969803): Remove this.
			...
			"memfd_create": `!(betty || reven || tast_vm)`,
			"memd":         "memd",
			...
			"microcode":             "!betty && !reven && !tast_vm",
			"ml_benchmark_drivers":  "ml_benchmark_drivers",
			"ml_service":            "ml_service",
			"mosys":                 "!betty && !reven && !tast_vm",
			"nacl":                  "nacl",
			...
			"pstore":                "!betty && !reven && !tast_vm", // These boards don't support pstore: https://crbug.com/971899
			"qemu":                  "betty || reven || tast_vm",
			"racc":                  "racc",
			...
			"smartdim":               "smartdim",
			"smartctl":               "nvme || sata",
			"storage_wearout_detect": "storage_wearout_detect && !betty && !reven && !tast_vm", // Skip wearout checks for VMs and eMMC < 5.0
			...
			"wifi":        "!betty && !reven && !tast_vm && !nyan_kitty",
			"wilco":       "wilco",
