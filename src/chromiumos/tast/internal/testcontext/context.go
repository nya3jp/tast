...
// OutDir is similar to ????.OutDir but takes context instead. It is intended to be
...
// SoftwareDeps is similar to ????.SoftwareDeps but takes context instead.
...
// ServiceDeps is similar to ???.ServiceDeps but takes context instead.
// It is intended to be used by packages providing support for tests that want to
// make sure tests declare proper dependencies.
