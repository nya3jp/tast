...
([example](https://chromium-review.googlesource.com/c/chromiumos/overlays/chromiumos-overlay/+/1737396))

Tast doesn't have any official process to review third party libraries.
Just take usual precautions on introducing the library, such as
