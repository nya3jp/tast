...
1. Add an ebuild to package the code as a Portage package in [third_party/chromiumos-overlay], and they will effectively review third party licensing. [example](https://chromium-review.googlesource.com/c/chromiumos/overlays/chromiumos-overlay/+/600996)
2. Add the dependency to tast-build-deps. [example](https://chromium-review.googlesource.com/c/chromiumos/overlays/chromiumos-overlay/+/1808333)
