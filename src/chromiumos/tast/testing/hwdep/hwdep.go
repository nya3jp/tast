...
// modelListed returns whether the model represented by a protocol.DeviceInfo is listed
// in the given list of names or not.
func modelListed(di *protocol.DeviceInfo, names ...string) (bool, error) {
...
func platformListed(di *protocol.DeviceInfo, names ...string) (bool, error) {
...
func Model(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) error {
		listed, err := modelListed(f.DeviceInfo, names...)
		if err != nil {
			return err
		}
		if !listed {
...
func Platform(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) error {
		listed, err := platformListed(f.GetDeviceInfo(), names...)
		if err != nil {
			return err
		}
		if !listed {
...
func SkipOnPlatform(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) error {
		listed, err := platformListed(f.DeviceInfo, names...)
		if err != nil {
			return err
		}
		if listed {
...
func ForceDischarge() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) error {
		...
		doesNotSupportForceDischarge, err := modelListed(f.GetDeviceInfo(), modelsWithoutForceDischargeSupport...)
		if err != nil {
			return err
		}
