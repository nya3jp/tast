...
var (
	...
	fakeFixture1 *testing.FixtureInstance = &testing.FixtureInstance{Name: "fake1"}
	fakeFixture2 *testing.FixtureInstance = &testing.FixtureInstance{Name: "fake2", Parent: "fake1"}
)
