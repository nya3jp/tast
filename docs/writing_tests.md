...
Tast supports parameterized tests to generate variations of the test. See [parameterized_tests.md] for details.

[parameterized_tests.md]: features/parameterized_tests.md
