...
func Test(ctx context.Context, s *testing.State) {
	...
	testing.ContextLogf(ctx, "Should've used ContextLog: %v", err)
	s.Errorf("unexpected usage Errorf for single trailing %v", err)        // CASE 3+10->4
	s.Fatalf("unexpected usage Errorf for \"%s\" single trailing %v", err) // CASE 3+7+10->4
	// CASE 4:
	s.Log("Should end with colon and space ", err)
...
func Test(ctx context.Context, s *testing.State) {
	...
	s.Error("Unexpected usage Errorf for single trailing: ", err)    // CASE 3+10->4
	s.Fatal("Unexpected usage Errorf for %q single trailing: ", err) // CASE 3+7+10->4
	// CASE 4:
	s.Log("Should end with colon and space: ", err)
	s.Error("Should end with colon and space: ", err)
	s.Fatal("Should end with colon and space: ", err)                                    // CASE 4+6
