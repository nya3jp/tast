...
func TestRunTests(t *gotesting.T) {
	...
	reg.AddRunnableTest(&testing.RunnableTest{
		Name:    name1,
...
func TestRunTestsNoTests(t *gotesting.T) {
	...
	if err := runTests(context.Background(), &bytes.Buffer{}, &Args{RunTests: &RunTestsArgs{}},
		&runConfig{}, localBundle, []*testing.RunnableTest{}); !errorHasStatus(err, statusNoTests) {
...
func TestRunTestsMissingDeps(t *gotesting.T) {
	...
	testing.AddRunnableTest(&testing.RunnableTest{Name: validName, Func: makeFunc(validName), SoftwareDeps: []string{validDep}})
	testing.AddRunnableTest(&testing.RunnableTest{Name: missingName, Func: makeFunc(missingName), SoftwareDeps: []string{missingDep}})
	testing.AddRunnableTest(&testing.RunnableTest{Name: unregName, Func: makeFunc(unregName), SoftwareDeps: []string{unregDep}})
...
func TestRunTestsSkipTestWithPrecondition(t *gotesting.T) {
	...
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test1", Func: f, Pre: pre1})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test2", Func: f, Pre: pre1})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test3", Func: f, Pre: pre1, SoftwareDeps: []string{"dep"}})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test4", Func: f, Pre: pre2})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test5", Func: f, Pre: pre2})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test6", Func: f, Pre: pre2, SoftwareDeps: []string{"dep"}})
...
func TestRunRemoteData(t *gotesting.T) {
	...
	testing.AddRunnableTest(&testing.RunnableTest{
		Name: "meta.Test",
...
func TestRunList(t *gotesting.T) {
	...
	defer restore()
	f := func(context.Context, *testing.State) {}
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test", Func: f})
	testing.AddRunnableTest(&testing.RunnableTest{Name: "pkg.Test2", Func: f})
...
func TestRunRegistrationError(t *gotesting.T) {
	...
	testing.AddRunnableTest(&testing.RunnableTest{Name: name, Func: testFunc})
...
func TestTestsToRunSortTests(t *gotesting.T) {
	...
	restore := testing.SetGlobalRegistryForTesting(testing.NewRegistry())
	defer restore()
	testing.AddRunnableTest(&testing.RunnableTest{Name: test2, Func: testFunc})
	testing.AddRunnableTest(&testing.RunnableTest{Name: test3, Func: testFunc})
	testing.AddRunnableTest(&testing.RunnableTest{Name: test1, Func: testFunc})
...
func TestTestsToRunTestTimeouts(t *gotesting.T) {
	...
	restore := testing.SetGlobalRegistryForTesting(testing.NewRegistry())
	defer restore()
	testing.AddRunnableTest(&testing.RunnableTest{Name: name1, Func: testFunc, Timeout: customTimeout})
	testing.AddRunnableTest(&testing.RunnableTest{Name: name2, Func: testFunc})
