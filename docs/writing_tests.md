...
if it doesn't meat your needs. For example, if your test needs to verify that
...
As an example, what you should do instead, is forcing the initial clamshell mode
by injecting the `SW_TABLET_MODE`
