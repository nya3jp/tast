...
Software features are composed from USE flags. The expressions used to generate
features are defined in [local_test_runner]. Before a new USE flag can be used
in an expression, it must be added to `IUSE` in the [tast-use-flags] package.
