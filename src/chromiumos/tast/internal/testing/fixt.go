...
type FixtureImpl interface {
	...
	// operations.
	//
	// The context and state passed to SetUp are fixture-scoped, i.e. the context is
	// alive and the state is valid until TearDown returns. The context and state are associated
	// with the fixture itself, not with any test depending on the fixture. For example,
	// testing.ContextOutDir(ctx) returns the output directory allocated to the fixture itself.
	// testing.ContextSoftwareDeps(ctx) fails for the context since fixtures can't declare software
	// dependencies.
	//
	...
	// light-weight adjustment of the environment to the original state.
	//
	// The context passed to this method is fixture-scoped. See SetUp for details.
	//
	...
	//
	// Returning an error from Reset is valid when light-weight adjustment doesn't restore the
	...
	//
	// The context and state passed to this method are test-scoped, i.e. the context is alive and
	// the state is valid until PostTest returns. The context and state are associated with the
	// next test, not with the fixture itself. For example, testing.ContextOutDir(ctx) returns the
	// output directory allocated for the next test.
	//
	...
	//
	// The context and state passed to this method are test-scoped. See PreTest for details.
	//
	...
	//
	// The context and state passed to this method are fixture-scoped. See SetUp for details.
	//
