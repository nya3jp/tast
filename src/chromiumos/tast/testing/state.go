...
type rootState struct {
	test *RunnableTest // test being run
...
type TestConfig struct {
	...
	NextTest *RunnableTest
}

// newRootState returns a new rootState object.
func newRootState(test *RunnableTest, ch chan<- Output, cfg *TestConfig) *rootState {
	return &rootState{test: test, ch: ch, cfg: cfg}
}

func newState(test *RunnableTest, ch chan<- Output, cfg *TestConfig) *State {
