...
// ErrMaxFailuresReach is error to be used when the user specified maximun number failures has reached.
var ErrMaxFailuresReach = errors.New("the maximun number of failures reached")
