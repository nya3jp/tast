...
func Test(ctx context.Context, s *testing.State) {
	...
	expects := []string{
		...
		`test.go:105:2: s.Error has verbs in string literal. Do you mean s.Errorf?`,
		`test.go:106:2: errors.Wrap has verbs in string literal. Do you mean errors.Wrapf?`,
		`test.go:107:2: testing.ContextLog has verbs in string literal. Do you mean testing.ContextLogf?`,
	}
