...
func writeGetDUTInfoResult(w io.Writer, avail, unavail []string, dc *device.Config, hw *configpb.HardwareFeatures) error {
...
func checkRunnerTestDepsArgs(t *testing.T, cfg *Config, checkDeps bool, avail, unavail []string, dc *device.Config, hw *configpb.HardwareFeatures) {
	t.Helper()
	args := runner.Args{
...
func TestGetDUTInfo(t *testing.T) {
	...
	td.runFunc = func(args *runner.Args, stdout, stderr io.Writer) (status int) {
		...
		writeGetDUTInfoResult(stdout, avail, unavail, dc, hw)
		return 0
	}
	...
	checkRunnerTestDepsArgs(t, &td.cfg, true, avail, unavail, dc, hw)
