...
*   `video_decoder_direct` - the direct video decoder (VD)
*   `video_decoder_legacy` - the video decoder accelerator (VDA)
*   `video_decoder_legacy_supported` - the video accelerator is *not* supported on this platform
