...
func main() {
	...
	cfg := runner.Config{
		...
		SoftwareFeatureDefinitions: map[string]string{
			...
			"android":    `arc && ("android-container-nyc" || "android-container-pi") && !("android-container-master-arc-dev" || "android-container-qt")`,
			"android_vm": `arc && arcvm`,
			// Run only ARC stable versions.
			"android_both": `arc && !"android-container-master-arc-dev" && !"android-container-qt"`,
			// Run all ARC container versions, including both stable and unstable ones.
			"android_all":       `arc && ("android-container-nyc" || "android-container-pi" || "android-container-qt" || "android-container-master-arc-dev")`,
