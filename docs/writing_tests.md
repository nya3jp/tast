...
*   `testing.ContextOutDir` returns a path to a temporary directory. If any file
    is created in the directory at the end of a gRPC method call, they are
    copied to the host machine as if they were saved by a remote test that
