...
// TODO(oka): rename this to indicate this is test only.
...
// This should not be used outside of unittests.
...
// This should not be used outside unittests.
...
// Close releaes resources associated to td.
