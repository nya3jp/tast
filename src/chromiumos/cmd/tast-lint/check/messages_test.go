...
func Test(ctx context.Context, s *testing.State) {
	...
	expects := []string{
		...
		`test.go:105:2: s.Error has verbs in format literal. Do you mean s.Errorf?`,
		`test.go:106:2: errors.Wrap has verbs in format literal. Do you mean errors.Wrapf?`,
	}
