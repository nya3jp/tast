...
func main() {
	...
	cfg := runner.Config{
		...
		SoftwareFeatureDefinitions: map[string]string{
			...
			"amd64":       "amd64",
			// TODO(yusukes): This is a temporary hack for running arc.Boot on ARCVM P. Remove once we abandon ARCVM P.
			"android_vm_p_deprecated": `arc && arcvm && "android-vm-pi"`,
			...
			"p2p_stable":             `"kernel-3_8" || "kernel-3_10" || "kernel-3_14" || "kernel-3_18" || "kernel-4_4" || "kernel-4_14" || "kernel-4_19"`,
			"p2p_unstable":           `!("kernel-3_8" || "kernel-3_10" || "kernel-3_14" || "kernel-3_18" || "kernel-4_4" || "kernel-4_14" || "kernel-4_19")`,
