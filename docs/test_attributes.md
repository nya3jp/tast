...
*   `group:wificell` - Tests that depends on [wificell] fixture to run. Currently it has only one sub-attribute: `wifi_func`, which is used to verify basic WiFi functionalities.
