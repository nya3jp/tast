...
func TestRunTests(t *gotesting.T) {
	...
	wantEvents := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: name1, Text: preTestMsg, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: name1, Text: postTestMsg, Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: name1},
		&protocol.EntityStartEvent{Entity: tests[1].EntityProto()},
		&protocol.EntityLogEvent{EntityName: name2, Text: preTestMsg, Level: protocol.LogLevel_INFO},
		&protocol.EntityErrorEvent{EntityName: name2, Error: &protocol.Error{Reason: errorMsg}},
		&protocol.EntityLogEvent{EntityName: name2, Text: postTestMsg, Level: protocol.LogLevel_INFO},
