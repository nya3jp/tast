...
func (s *fakeServer) handleStatic(w http.ResponseWriter, r *http.Request) {
	stagePath := strings.TrimPrefix(r.URL.Path, "/static/")
...
func TestRealClientSimple(t *testing.T) {
	...
	cl := NewRealClient(nil)
	cl.SetServers(context.Background(), []string{s.URL})
...
func TestRealClientPreferStagedServer(t *testing.T) {
	...
	cl := NewRealClient(nil)
	cl.SetServers(context.Background(), []string{s1.URL, s2.URL})
...
func TestRealClientSomeUpServers(t *testing.T) {
	...
	cl := NewRealClient(nil)
	cl.SetServers(context.Background(), []string{up1.URL, down.URL, up2.URL})
...
func TestRealClientNoUpServer(t *testing.T) {
	...
	cl := NewRealClient(nil)
	cl.SetServers(context.Background(), []string{down1.URL, down2.URL})
