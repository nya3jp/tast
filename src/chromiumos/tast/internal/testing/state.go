...
// NewContextWithGlobalVarConstraints creates a new context with additional constraints to the current one.
func NewContextWithGlobalVarConstraints(ctx context.Context, allVars map[string]interface{}) context.Context {
	return testcontext.NewContextWithGlobalVarConstraints(ctx, allVars)
}
