...
func TestReadArgsSortTests(t *gotesting.T) {
	...
	tests, err := readArgs(nil, newBufferWithArgs(t, &Args{}), &bytes.Buffer{},
...
func TestReadArgsTestTimeouts(t *gotesting.T) {
	...
	tests, err := readArgs(nil, newBufferWithArgs(t, &Args{}), &bytes.Buffer{}, &Args{},
...
func TestReadArgsRegistrationError(t *gotesting.T) {
	...
	if _, err := readArgs(nil, newBufferWithArgs(t, &Args{}), &bytes.Buffer{}, &Args{},
