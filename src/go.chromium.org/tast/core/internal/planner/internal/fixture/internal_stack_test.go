...
func TestInternalStackOutputGreen(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "SetUp 1 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "SetUp 1 via Fixture-scoped Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "SetUp 1 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityStartEvent{Entity: fixt2.EntityProto()},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "SetUp 2 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "SetUp 2 via Fixture-scoped Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "SetUp 2 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PreTest 1 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PreTest 1 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PreTest 2 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PreTest 2 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PostTest 2 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PostTest 2 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PostTest 1 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "PostTest 1 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "Reset 1 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "Reset 2 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "TearDown 2 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "TearDown 2 via Fixture-scoped Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "TearDown 2 via State", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: "fixt2"},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "TearDown 1 via Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "TearDown 1 via Fixture-scoped Context", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "TearDown 1 via State", Level: protocol.LogLevel_INFO},
...
func TestInternalStackOutputRed(t *gotesting.T) {
	...
	want := []protocol.Event{
		&protocol.EntityStartEvent{Entity: fixt1.EntityProto()},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "SetUp 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityStartEvent{Entity: fixt2.EntityProto()},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "SetUp 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityErrorEvent{EntityName: "fixt2", Error: &protocol.Error{Reason: "SetUp 2 failure"}},
		&protocol.EntityEndEvent{EntityName: "fixt2"},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "TearDown 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: "fixt1"},
	}
	if diff := cmp.Diff(msgs, want, protocmp.Transform()); diff != "" {
		t.Error("Output mismatch (-got +want):\n", diff)
...
func TestInternalStackOutputYellow(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: "fixt3", Text: "SetUp 3", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "Reset 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "Reset 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "Fixture failed to reset: failure; recovering", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: "fixt3", Text: "TearDown 3", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: "fixt3"},
		&protocol.EntityLogEvent{EntityName: "fixt2", Text: "TearDown 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: "fixt2"},
		&protocol.EntityLogEvent{EntityName: "fixt1", Text: "TearDown 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: "fixt1"},
	}
