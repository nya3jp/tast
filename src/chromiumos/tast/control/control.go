...
type TestEnd struct {
	...
	// MissingVars contains vars declared by the test that were
	// not present in args. If non-empty, the test was skipped.
	MissingVars []string `json:"testEndMissingVars"`
