...
var (
	...
	KnownVariants = map[string]DeviceInfo{
		...
		"chinchou_rw101":     {"chinchou_rw101", "corsola", ModemTypeRW101},
		...
		"anraggar_rw101":     {"anraggar_rw101", "nissa", ModemTypeRW101},
		"craask_fm101":       {"craask_fm101", "nissa", ModemTypeFM101},
		"domika_fm101":       {"domika_fm101", "nissa", ModemTypeFM101},
		"domika_rw101":       {"domika_rw101", "nissa", ModemTypeRW101},
		"domilly_fm101":      {"domilly_fm101", "nissa", ModemTypeFM101},
		"domilly_rw101":      {"domilly_rw101", "nissa", ModemTypeRW101},
		"domiso_fm101":       {"domiso_fm101", "nissa", ModemTypeFM101},
		"domiso_rw101":       {"domiso_rw101", "nissa", ModemTypeRW101},
		...
		"guren360_rw135":     {"guren360_rw135", "nissa", ModemTypeRW135},
		"guren_rw135":        {"guren_rw135", "nissa", ModemTypeRW135},
		...
		"pujjoteenlo_rw101":  {"pujjoteenlo_rw101", "nissa", ModemTypeRW101},
		...
		"jaina_rw101":        {"jaina_rw101", "skywalker", ModemTypeRW101},
		"kylo_rw101":         {"kylo_rw101", "skywalker", ModemTypeRW101},
		"leia_rw101":         {"leia_rw101", "skywalker", ModemTypeRW101},
		...
		"jaina_rw135":        {"jaina_rw135", "skywalker", ModemTypeRW135},
		"kylo_rw135":         {"kylo_rw135", "skywalker", ModemTypeRW135},
		"leia_rw135":         {"leia_rw135", "skywalker", ModemTypeRW135},
