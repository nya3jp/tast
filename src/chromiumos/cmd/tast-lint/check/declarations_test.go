...
`
	...
	expects := []string{
		...
		declTestPath + ":31:13: " + nonLiteralAttrMsg,
		declTestPath + ":33:18: " + emptyAttrMsg,
		declTestPath + ":57:27: " + emptyAttrMsg,
		declTestPath + ":61:15: " + emptyAttrMsg,
		declTestPath + ":80:13: " + nonLiteralAttrMsg,
		declTestPath + ":93:15: " + nonLiteralAttrMsg,
		declTestPath + ":96:15: " + nonLiteralAttrMsg,
	}
	verifyIssues(t, issues, expects)
}
