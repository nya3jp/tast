...
func SkipOnModel(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if listed {
			return false, "ModelId matched with skip-on list", nil
		}
		return satisfied()
	}}
}
...
func Platform(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if !listed {
			return false, "PlatformId did not match", nil
		}
		return satisfied()
	}}
}
...
func SkipOnPlatform(names ...string) Condition {
	...
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if listed {
			return false, "PlatformId matched with skip-on list", nil
		}
		return satisfied()
	}}
}
...
func TouchScreen() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if hf == nil {
			return false, "", errors.New("DUT HardwareFeatures data is not given")
		}
		if hf.GetScreen().GetTouchSupport() == configpb.HardwareFeatures_PRESENT {
			return satisfied()
		}
		return false, "DUT does not have touchscreen", nil
...
func ChromeEC() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		hf := f.GetHardwareFeatures()
		if hf == nil {
			return false, "", errors.New("Did not find hardware features")
		}
		...
		return false, "DUT does not have chrome EC", nil
...
func Fingerprint() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		hf := f.GetHardwareFeatures()
		if hf == nil {
			return false, "", errors.New("HardwareFeatures is not given")
		}
		if hf.GetFingerprint().GetLocation() == configpb.HardwareFeatures_Fingerprint_NOT_PRESENT {
			return false, "DUT does not have fingerprint sensor", nil
		}
		return satisfied()
...
func NoFingerprint() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if hf.GetFingerprint().GetLocation() != configpb.HardwareFeatures_Fingerprint_NOT_PRESENT {
			return false, "DUT has fingerprint sensor", nil
		}
		return satisfied()
	}, CEL: "dut.hardware_features.fingerprint.location == api.HardwareFeatures.Fingerprint.Location.NOT_PRESENT",
	}
...
func InternalDisplay() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		return false, "DUT does not have an internal display", nil
...
func Battery() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if !hasBattery {
			return false, "DUT does not have a battery", nil
		}
		return satisfied()
	}}
}
...
func SupportsNV12Overlays() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		...
		if dc.GetSoc() == protocol.DeprecatedDeviceConfig_SOC_HASWELL ||
			...
			return false, "SoC does not support NV12 Overlays", nil
		}
		return satisfied()
	}}
}
...
func NoX86() Condition {
	return Condition{Satisfied: func(f *protocol.HardwareFeatures) (bool, string, error) {
		dc := f.GetDeprecatedDeviceConfig()
		if dc == nil {
			return withError(errors.New("DeprecatedDeviceConfig is not given"))
		}
		if dc.GetCpu() != protocol.DeprecatedDeviceConfig_X86 && dc.GetCpu() != protocol.DeprecatedDeviceConfig_X86_64 {
			return satisfied()
		}
