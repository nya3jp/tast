...
func main() {
	...
	cfg := runner.Config{
		...
		SoftwareFeatureDefinitions: map[string]string{
			...
			"arc32to64":         `("cheets_user_64" || "cheets_userdebug_64") && ("board:kukui" || "board:kukui-arc64" || "board:kukui-arc-r" || "board:elm" || "board:hana" || "board:jacuzzi" || "board:sarien" || "board:grunt" || "board:reef" || "board:snappy" || "board:pyro" || "board:sand" || "board:coral" || "board:kevin" || "board:kevin-arc64" || "board:bob" || "board:dru" || "board:scarlet" || "board:caroline" || "board:cave" || "board:chell" || "board:sentry" || "board:asuka")`,
			"arcno32to64":       `!("cheets_user_64" || "cheets_userdebug_64") || !("board:kukui" || "board:kukui-arc64" || "board:kukui-arc-r" || "board:elm" || "board:hana" || "board:jacuzzi" || "board:sarien" || "board:grunt" || "board:reef" || "board:snappy" || "board:pyro" || "board:sand" || "board:coral" || "board:kevin" || "board:kevin-arc64" || "board:bob" || "board:dru" || "board:scarlet" || "board:caroline" || "board:cave" || "board:chell" || "board:sentry" || "board:asuka")`,
