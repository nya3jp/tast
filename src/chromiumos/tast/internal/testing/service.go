...
type ServiceRoot struct {
	...
	service *Service
	// testVars has the run-time test variables.
	testVars map[string]string
}

// NewServiceRoot creates a new ServiceRoot object.
func NewServiceRoot(svc *Service, testVars map[string]string) *ServiceRoot {
	return &ServiceRoot{service: svc, testVars: testVars}
}
