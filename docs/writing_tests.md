...
#### Creating a new precondition

If you want a a new Chrome precondition with custom options
...
registering themselves. It would be a good idea to have a subpackage where you
can store precondition.
...
[video tests' pre subpackage]: https://chromium.git.corp.google.com/chromiumos/platform/tast-tests/+/refs/heads/master/src/chromiumos/tast/local/bundles/cros/video/lib/pre/pre.go
