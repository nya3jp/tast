...
func isCrashFile(filename string) bool {
	...
	case CoreExt, MinidumpExt, LogExt, MetadataExt, GPUStateExt:
		return true
	case CompressedLogExt1:
		...
		subname := strings.TrimSuffix(filename, CompressedLogExt1)
		return filepath.Ext(subname) == CompressedLogExt2
	default:
		return false
	}
}
