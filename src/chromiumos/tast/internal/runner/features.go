...
func handleGetDUTInfo(args *jsonprotocol.RunnerArgs, scfg *StaticConfig, w io.Writer) error {
	...
	if args.GetDUTInfo.RequestDeviceConfig {
		var ws []string
		deviceInfo, hwFeatures, ws = newDeviceConfigAndHardwareFeatures()
...
func newDeviceConfigAndHardwareFeatures() (retDeviceInfo *protocol.DeviceInfo, retFeatures *configpb.HardwareFeatures, warns []string) {
