...
func (a *Args) bundleArgs(mode bundle.RunMode) *bundle.Args {
	...
	case bundle.RunTestsMode:
		...
		default:
			panic(fmt.Sprint("Can't make RunTests bundle args in runner mode ", int(a.Mode)))
		}
	case bundle.ListTestsMode:
		...
		default:
			panic(fmt.Sprint("Can't make ListTests bundle args in runner mode ", int(a.Mode)))
		}
	}
