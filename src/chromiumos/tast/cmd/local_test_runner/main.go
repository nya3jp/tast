...
func main() {
	...
	cfg := runner.Config{
		...
		SoftwareFeatureDefinitions: map[string]string{
			...
			// Asuka, banon, caroline, cave, celes, chell, cyan, edgar, kefka, reks, relm, sentry, terra, ultima, and wizpig have buggy EC firmware and cannot capture crash reports. https://crbug.com/1123191
