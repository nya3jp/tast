...
func TestWriteJUnitResults(t *gotesting.T) {
	...
	results := []*EntityResult{
		&EntityResult{
			...
			Errors:     []EntityError{},
			Start:      time.Date(2021, 2, 3, 10, 00, 02, 0, time.UTC),
			End:        time.Date(2021, 2, 3, 10, 00, 03, 0, time.UTC),
		...
		&EntityResult{
			...
			Errors:     []EntityError{},
			Start:      time.Date(2021, 2, 3, 10, 00, 03, 0, time.UTC),
			End:        time.Date(2021, 2, 3, 10, 00, 05, 0, time.UTC),
			...
			Errors: []EntityError{
				{
					...
					Time: time.Date(2021, 2, 3, 10, 0, 10, 0, time.UTC),
				},
			},
			Start: time.Date(2021, 2, 3, 10, 0, 7, 0, time.UTC),
			// Start time.Time `json:"start"`
			End:        time.Date(2021, 2, 3, 10, 0, 10, 0.5e9, time.UTC),
	...
	expected := strings.Split(
		`<testsuites name="cros" tests="3" failures="1" skipped="1">
  <testcase name="example.Pass" result="completed" status="run" timestamp="2021-02-03Z10:00:02" time="1.0"></testcase>
  <testcase name="example.Skip" status="run" timestamp="2021-02-03Z10:00:03" time="2.0">
    <skipped message="skipped by a certain reason"></skipped>
  </testcase>
  <testcase name="example.Fail" result="completed" status="run" timestamp="2021-02-03Z10:00:07" time="3.5">
