...
func toDeviceConfigPowerSupply(power protocol.DeviceInfo_PowerSupply) device.Config_PowerSupply {
	switch power {
	case protocol.DeviceInfo_POWER_SUPPLY_UNSPECIFIED:
		return device.Config_POWER_SUPPLY_UNSPECIFIED
	case protocol.DeviceInfo_POWER_SUPPLY_BATTERY:
		return device.Config_POWER_SUPPLY_BATTERY
	case protocol.DeviceInfo_POWER_SUPPLY_AC_ONLY:
