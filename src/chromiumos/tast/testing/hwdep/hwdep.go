...
func ChromeEC() Condition {
	...
	}, CEL: "dut.hardware_features.embedded_controller.present == api.HardwareFeatures_Present && dut.hardware_features.embedded_controller.ec_type == api.HardwareFeatures.EmbeddedController.EcType.EC_CHROME",
	}
}
