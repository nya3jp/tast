...
import (
	...
	"go.chromium.org/tast/core/internal/devserver/devservertest"
...
func TestRunLogAfterTimeout(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: "pkg.Test", Text: "Dumping all goroutines", Level: protocol.LogLevel_INFO},
...
func TestRunSkipStages(t *gotesting.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			want: []protocol.Event{
				&protocol.EntityStartEvent{Entity: &protocol.Entity{Name: "0", LacrosStatus: "unknown"}},
				&protocol.EntityLogEvent{EntityName: "0", Text: "preTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "test: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "postTest: OK", Level: protocol.LogLevel_INFO},
		...
		},
		{
			...
			want: []protocol.Event{
				&protocol.EntityStartEvent{Entity: &protocol.Entity{Name: "0", LacrosStatus: "unknown"}},
				&protocol.EntityLogEvent{EntityName: "0", Text: "preTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: `Preparing precondition "pre1"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "prepare: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "test: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: `Closing precondition "pre1"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "close: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "0", Text: "postTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityEndEvent{EntityName: "0"},
			},
		},
		...
		},
		{
			...
			want: []protocol.Event{
				...
				&protocol.EntityLogEvent{EntityName: "0", Text: "postTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityEndEvent{EntityName: "0"},
				&protocol.EntityStartEvent{Entity: &protocol.Entity{Name: "1", LacrosStatus: "unknown"}},
				&protocol.EntityLogEvent{EntityName: "1", Text: "preTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: `Preparing precondition "pre1"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "prepare: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "test: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: `Closing precondition "pre1"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "close: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "postTest: OK", Level: protocol.LogLevel_INFO},
		...
		},
		{
			...
			want: []protocol.Event{
				...
				&protocol.EntityStartEvent{Entity: &protocol.Entity{Name: "1", LacrosStatus: "unknown"}},
				&protocol.EntityLogEvent{EntityName: "1", Text: "preTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: `Preparing precondition "pre2"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "prepare: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "test: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: `Closing precondition "pre2"`, Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "close: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityLogEvent{EntityName: "1", Text: "postTest: OK", Level: protocol.LogLevel_INFO},
				&protocol.EntityEndEvent{EntityName: "1"},
			},
...
func TestRunFixture(t *gotesting.T) {
	...
	tests := []*testing.TestInstance{{
		...
		Func: func(ctx context.Context, s *testing.State) {
			...
			if deserializedVal != val1 {
				t.Errorf("pkg.Test1: FixtFillValue() = %v; want %v", deserializedVal, val1)
				return
			}
		},
		Timeout: time.Minute,
		...
		Func: func(ctx context.Context, s *testing.State) {
			...
			if deserializedVal != val2 {
				t.Errorf("pkg.Test2: FixtFillValue() = %v; want %v", deserializedVal, val2)
				return
			}
		},
		Timeout: time.Minute,
	...
	want := []protocol.Event{
		...
		&protocol.EntityStartEvent{Entity: tests[0].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "Test 0", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
		&protocol.EntityStartEvent{Entity: fixt1.EntityProto()},
		// pkg.Test1 depends on fixt1.
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "fixt1 SetUp", Level: protocol.LogLevel_INFO},
		&protocol.EntityStartEvent{Entity: tests[1].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "fixt1 PreTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "Test 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "fixt1 PostTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[1].Name},
		// fixt1 is reset.
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "fixt1 Reset", Level: protocol.LogLevel_INFO},
		// pkg.Test2 depends on fixt2, which in turn depends on fixt1.
		&protocol.EntityStartEvent{Entity: fixt2.EntityProto()},
		&protocol.EntityLogEvent{EntityName: fixt2.Name, Text: "fixt2 SetUp", Level: protocol.LogLevel_INFO},
		&protocol.EntityStartEvent{Entity: tests[2].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[2].Name, Text: "fixt1 PreTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[2].Name, Text: "fixt2 PreTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[2].Name, Text: "Test 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[2].Name, Text: "fixt2 PostTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[2].Name, Text: "fixt1 PostTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[2].Name},
		// fixt1 and fixt2 are torn down.
		&protocol.EntityLogEvent{EntityName: fixt2.Name, Text: "fixt2 TearDown", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: fixt2.Name},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "fixt1 TearDown", Level: protocol.LogLevel_INFO},
...
func TestPreTestName(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityStartEvent{Entity: fixt1.EntityProto()},
		&protocol.EntityStartEvent{Entity: tests[0].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "fixt1 PreTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "fixt1 TestName" + tests[0].Name, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "Test 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
		// pkg.Test2 depends on fixt1.
		&protocol.EntityStartEvent{Entity: tests[1].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "fixt1 PreTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "fixt1 TestName" + tests[1].Name, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "Test 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[1].Name},
		&protocol.EntityEndEvent{EntityName: fixt1.Name},
	}
	if diff := cmp.Diff(msgs, want, protocmp.Transform()); diff != "" {
...
func TestRunFixturePreTestFailure(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "fixt1 PostTest", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
		&protocol.EntityEndEvent{EntityName: fixt2.Name},
		&protocol.EntityEndEvent{EntityName: fixt1.Name},
	}
...
func TestRunFixtureResetFailure(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityStartEvent{Entity: fixt1.EntityProto()},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "SetUp 1", Level: protocol.LogLevel_INFO},
		// pkg.Test1 runs successfully.
		&protocol.EntityStartEvent{Entity: tests[1].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "Test 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[1].Name},
		// fixt1 fails to reset. It is restarted.
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Reset 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Fixture failed to reset: failure; recovering", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "TearDown 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: fixt1.Name},
		// fixt1 and fixt2 set up successfully.
		&protocol.EntityStartEvent{Entity: fixt1.EntityProto()},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "SetUp 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityStartEvent{Entity: fixt2.EntityProto()},
		&protocol.EntityLogEvent{EntityName: fixt2.Name, Text: "SetUp 2", Level: protocol.LogLevel_INFO},
		...
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Reset 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Fixture failed to reset: failure; recovering", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt2.Name, Text: "TearDown 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: fixt2.Name},
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "TearDown 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: fixt1.Name},
		// fixt1 and fixt2 set up successfully.
		...
		&protocol.EntityStartEvent{Entity: tests[3].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[3].Name, Text: "Test 3", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[3].Name},
...
func TestRunFixtureMinimumReset(t *gotesting.T) {
	...
	want := []protocol.Event{
		...
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Reset 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt2.Name, Text: "Reset 2", Level: protocol.LogLevel_INFO},
		// pkg.Test4 runs.
		...
		&protocol.EntityLogEvent{EntityName: fixt1.Name, Text: "Reset 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: fixt3.Name, Text: "Reset 3", Level: protocol.LogLevel_INFO},
		// pkg.Test6 runs.
...
func TestRunPrecondition(t *gotesting.T) {
	...
	want := []protocol.Event{
		&protocol.EntityStartEvent{Entity: tests[0].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: `Preparing precondition "pre"`, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: `Closing precondition "pre"`, Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
	}
	if diff := cmp.Diff(msgs, want, protocmp.Transform()); diff != "" {
		t.Error("Output mismatch (-got +want):\n", diff)
...
func TestRunPreconditionContext(t *gotesting.T) {
	...
	want := []protocol.Event{
		&protocol.EntityStartEvent{Entity: tests[0].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: `Preparing precondition "pre"`, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "Log via PreCtx", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
		&protocol.EntityStartEvent{Entity: tests[1].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: `Preparing precondition "pre"`, Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: "Log via PreCtx", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[1].Name, Text: `Closing precondition "pre"`, Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[1].Name},
	}
	if diff := cmp.Diff(msgs, want, protocmp.Transform()); diff != "" {
		t.Error("Output mismatch (-got +want):\n", diff)
...
func TestAttachStateToContext(t *gotesting.T) {
	...
	want := []protocol.Event{
		&protocol.EntityStartEvent{Entity: tests[0].EntityProto()},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "msg 1", Level: protocol.LogLevel_INFO},
		&protocol.EntityLogEvent{EntityName: tests[0].Name, Text: "msg 2", Level: protocol.LogLevel_INFO},
		&protocol.EntityEndEvent{EntityName: tests[0].Name},
	}
	if diff := cmp.Diff(msgs, want, protocmp.Transform()); diff != "" {
		t.Error("Output mismatch (-got +want):\n", diff)
