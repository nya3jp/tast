...
func ForbiddenBundleImports(fs *token.FileSet, f *ast.File) []*Issue {
	...
	// src/chromiumos/tast/local/bundles/cros/arc/boot.go
	fmt.Printf("filename: %q, pkg: %q", filename, mypkg) // FIXME
	...
	for _, im := range f.Imports {
		...
		issues = append(issues, &Issue{
			...
			Link: "https://chromium.googlesource.com/chromiumos/platform/tast/+/HEAD/docs/writing_tests.md#import-bundle-subpackage",
		})
	}
