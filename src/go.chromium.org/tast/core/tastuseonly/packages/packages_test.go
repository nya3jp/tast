...
func TestSplitFuncName(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{fn1, "go.chromium.org/tast/core/tastuseonly/packages_test", "TestSplitFuncName"},
		{fn2, "go.chromium.org/tast/core/tastuseonly/packages_test", "(*someStruct).method"},
		{fn3, "go.chromium.org/tast/core/tastuseonly/packages_test", "TestSplitFuncName.func1"},
	} {
