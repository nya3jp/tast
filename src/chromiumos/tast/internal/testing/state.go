...
// TestInstance returns a TestInstance associated with this root.
// Returned TestInstance must not be modified.
func (r *TestEntityRoot) TestInstance() *TestInstance {
	return r.test
}
