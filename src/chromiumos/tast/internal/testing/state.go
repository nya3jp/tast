...
func (r *RootState) RunWithTestState(ctx context.Context, f func(ctx context.Context, s *State)) {
	s := r.newTestState()
	ctx = NewContext(ctx, &s.BaseState)
	runAndRecover(func() { f(ctx, s) }, &s.BaseState)
}
...
func runAndRecover(f func(), s *BaseState) {
...
func NewContext(ctx context.Context, s *BaseState) context.Context {
