...
func (c *Cmd) Run(opts ...exec.RunOption) error {
...
func (c *Cmd) Output(opts ...exec.RunOption) ([]byte, error) {
	if c.Stdout != nil {
...
func (c *Cmd) CombinedOutput(opts ...exec.RunOption) ([]byte, error) {
	if c.Stdout != nil {
		return nil, errStdoutSet
	}
	if c.Stderr != nil {
...
func (c *Cmd) Wait(opts ...exec.RunOption) error {
