...
// Fixt descirbes a regisration of one or more fixture instances.
//
...
// Before a test or a servce is run, framework makes sure its ascendant fixtures are all set up.
//
...
type Fixt struct {
	...
	// - The postcondition: the condition this fixture may leave off. e.g. Chrome might be still running.
	Desc string
...
// Fixture provides implementation of a Fixt entitiy.
type Fixture interface {
	...
	// immediately aborts.
	// If errors are reported in Adjust, the following methods are called in order to reset the fixture:
