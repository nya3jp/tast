...
// Proto generates protocol.GetSysInfoStateResponse.
func (r *RunnerGetSysInfoStateResult) Proto() *protocol.GetSysInfoStateResponse {
...
// Proto generates protocol.CollectSysInfoRequest.
func (a *RunnerCollectSysInfoArgs) Proto() *protocol.CollectSysInfoRequest {
	return &protocol.CollectSysInfoRequest{
		InitialState: a.InitialState.Proto(),
	}
}
...
// Proto generates protocol.CollectSysInfoResponse.
func (r *RunnerCollectSysInfoResult) Proto() *protocol.CollectSysInfoResponse {
...
// Proto generates protocol.GetDUTInfoRequest.
func (a *RunnerGetDUTInfoArgs) Proto() *protocol.GetDUTInfoRequest {
	return &protocol.GetDUTInfoRequest{
		ExtraUseFlags: a.ExtraUSEFlags,
	}
}
...
// Proto generates protocol.SysInfoState.
func (s *SysInfoState) Proto() *protocol.SysInfoState {
	return &protocol.SysInfoState{
		LogInodeSizes:    s.LogInodeSizes,
		UnifiedLogCursor: s.UnifiedLogCursor,
		MinidumpPaths:    s.MinidumpPaths,
	}
}
...
// Proto generates protocol.DownloadPrivateBundlesRequest.
func (a *RunnerDownloadPrivateBundlesArgs) Proto() *protocol.DownloadPrivateBundlesRequest {
	return &protocol.DownloadPrivateBundlesRequest{
		...
		BuildArtifactUrl: a.BuildArtifactsURL,
	}
}
...
// Proto generates protocol.DownloadPrivateBundlesResponse.
func (a *RunnerDownloadPrivateBundlesResult) Proto() *protocol.DownloadPrivateBundlesResponse {
	return &protocol.DownloadPrivateBundlesResponse{}
}
