...
var file_testing_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x2d,
	0x5a, 0x2b, 0x67, 0x6f, 0x2e, 0x63, 0x68, 0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x2e, 0x6f, 0x72,
	0x67, 0x2f, 0x74, 0x61, 0x73, 0x74, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x69, 0x6e, 0x74, 0x65,
...
var file_testing_proto_goTypes = []interface{}{
	...
	(LogLevel)(0),                          // 60: tast.core.LogLevel
	(*protocol.DUTFeatures)(nil),           // 61: tast.core.DUTFeatures
}
var file_testing_proto_depIdxs = []int32{
	...
	60, // 48: tast.core.RunLogEvent.level:type_name -> tast.core.LogLevel
	59, // 49: tast.core.EntityStartEvent.time:type_name -> google.protobuf.Timestamp
	20, // 50: tast.core.EntityStartEvent.entity:type_name -> tast.core.Entity
	59, // 51: tast.core.EntityLogEvent.time:type_name -> google.protobuf.Timestamp
	59, // 52: tast.core.EntityErrorEvent.time:type_name -> google.protobuf.Timestamp
	31, // 53: tast.core.EntityErrorEvent.error:type_name -> tast.core.Error
	59, // 54: tast.core.EntityEndEvent.time:type_name -> google.protobuf.Timestamp
	42, // 55: tast.core.EntityEndEvent.skip:type_name -> tast.core.Skip
	34, // 56: tast.core.EntityEndEvent.timing_log:type_name -> tast.core.TimingLog
	61, // 57: tast.core.DUTInfo.features:type_name -> tast.core.DUTFeatures
	56, // 58: tast.core.SysInfoState.log_inode_sizes:type_name -> tast.core.SysInfoState.LogInodeSizesEntry
	46, // 59: tast.core.StackOperationRequest.reset:type_name -> tast.core.StackReset
	47, // 60: tast.core.StackOperationRequest.pre_test:type_name -> tast.core.StackPreTest
	48, // 61: tast.core.StackOperationRequest.post_test:type_name -> tast.core.StackPostTest
	49, // 62: tast.core.StackOperationRequest.status:type_name -> tast.core.StackGetStatus
	50, // 63: tast.core.StackOperationRequest.set_dirty:type_name -> tast.core.StackSetDirty
	51, // 64: tast.core.StackOperationRequest.errors:type_name -> tast.core.StackGetErrors
	52, // 65: tast.core.StackOperationRequest.value:type_name -> tast.core.StackValue
	20, // 66: tast.core.StackPreTest.entity:type_name -> tast.core.Entity
	20, // 67: tast.core.StackPostTest.entity:type_name -> tast.core.Entity
	2,  // 68: tast.core.StackOperationResponse.status:type_name -> tast.core.StackStatus
	31, // 69: tast.core.StackOperationResponse.errors:type_name -> tast.core.Error
	59, // 70: tast.core.HeartbeatEvent.time:type_name -> google.protobuf.Timestamp
	3,  // 71: tast.core.TestService.ListEntities:input_type -> tast.core.ListEntitiesRequest
	5,  // 72: tast.core.TestService.GlobalRuntimeVars:input_type -> tast.core.GlobalRuntimeVarsRequest
	8,  // 73: tast.core.TestService.RunTests:input_type -> tast.core.RunTestsRequest
	10, // 74: tast.core.TestService.GetDUTInfo:input_type -> tast.core.GetDUTInfoRequest
	12, // 75: tast.core.TestService.GetSysInfoState:input_type -> tast.core.GetSysInfoStateRequest
	14, // 76: tast.core.TestService.CollectSysInfo:input_type -> tast.core.CollectSysInfoRequest
	16, // 77: tast.core.TestService.DownloadPrivateBundles:input_type -> tast.core.DownloadPrivateBundlesRequest
	18, // 78: tast.core.TestService.StreamFile:input_type -> tast.core.StreamFileRequest
	4,  // 79: tast.core.TestService.ListEntities:output_type -> tast.core.ListEntitiesResponse
	7,  // 80: tast.core.TestService.GlobalRuntimeVars:output_type -> tast.core.GlobalRuntimeVarsResponse
	9,  // 81: tast.core.TestService.RunTests:output_type -> tast.core.RunTestsResponse
	11, // 82: tast.core.TestService.GetDUTInfo:output_type -> tast.core.GetDUTInfoResponse
	13, // 83: tast.core.TestService.GetSysInfoState:output_type -> tast.core.GetSysInfoStateResponse
	15, // 84: tast.core.TestService.CollectSysInfo:output_type -> tast.core.CollectSysInfoResponse
	17, // 85: tast.core.TestService.DownloadPrivateBundles:output_type -> tast.core.DownloadPrivateBundlesResponse
	19, // 86: tast.core.TestService.StreamFile:output_type -> tast.core.StreamFileResponse
