...
It is recommended to wrap when you cross package boundary, because everything beneath them are implementation details.
Otherwise it is fine to return an error without wrapping, if you can't really add much context to make debugging easier. Use your best judge to decide wrap or not.
