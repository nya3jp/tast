...
*   `android_all` - The ability to [run Android apps]. Any version of Android
    can be used.
...
*   `android_both` - The ability to [run Android apps] in any way, in VM or
    container, with any Android version.
