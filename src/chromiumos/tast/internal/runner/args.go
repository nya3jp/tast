...
type Config struct {
	...
	USEFlagsFile string
	// LSBReleaseFile contains the path to the LSBRelease file to determine board name used for
	// the expresisons in SoftwareFeatureDefinitions. If empty, it is interpreted as "/etc/lsb-release"
	// as the default value. This flag is for the testing purpose.
