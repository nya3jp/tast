...
func createLocalTestCategorizer(ctx context.Context, cfg *Config, hst *ssh.Conn) (localTestsCategorizer, error) {
	...
	///// 6. Create data structure to categorize local tests by bundle and remote fixture dep /////
...
func runLocalTests(ctx context.Context, cfg *Config) ([]TestResult, error) {
	...
	runMatchingTests := func(ctx context.Context, patterns []string) ([]TestResult, error) {
