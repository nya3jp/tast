...
func TestRunResults(t *gotesting.T) {
	...
	wrapper := stubRunWrapper{runRes: []run.TestResult{
		run.TestResult{
			RunnableTest: testing.RunnableTest{Name: "pkg.LocalTest"},
...
func TestRunExecFailure(t *gotesting.T) {
	...
	wrapper := stubRunWrapper{
		runRes:    []run.TestResult{run.TestResult{RunnableTest: testing.RunnableTest{Name: "pkg.LocalTest"}}},
...
func TestRunReserveTimeToWriteResults(t *gotesting.T) {
	wrapper := stubRunWrapper{
		runRes: []run.TestResult{run.TestResult{RunnableTest: testing.RunnableTest{Name: "pkg.Test"}}},
	}
