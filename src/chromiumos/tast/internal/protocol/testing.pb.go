...
type CollectSysInfoResponse struct {
	// LogDir is the directory where log files were copied. The caller should
	// delete it.
	LogDir string `protobuf:"bytes,1,opt,name=log_dir,json=logDir,proto3" json:"log_dir,omitempty"`
	// CrashDir is the directory where minidump crash files were copied. The
...
type DUTInfo struct {
	// Features contains features avaiable on the DUT.
