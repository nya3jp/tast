...
type RunFixtureRequest struct {
	...
	// Method if the method of the fixture to run.
...
// RunFixtureControl represents a control message sent to the caller.
type RunFixtureControl struct {
	// Types that are valid to be assigned to Control:
	//	*RunFixtureControl_Log
	//	*RunFixtureControl_Error
	Control              isRunFixtureControl_Control `protobuf_oneof:"control"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *RunFixtureControl) Reset()         { *m = RunFixtureControl{} }
func (m *RunFixtureControl) String() string { return proto.CompactTextString(m) }
func (*RunFixtureControl) ProtoMessage()    {}
func (*RunFixtureControl) Descriptor() ([]byte, []int) {
	return fileDescriptor_5cb9905fdd848d3a, []int{3}
}

func (m *RunFixtureControl) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RunFixtureControl.Unmarshal(m, b)
}
func (m *RunFixtureControl) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RunFixtureControl.Marshal(b, m, deterministic)
}
func (m *RunFixtureControl) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RunFixtureControl.Merge(m, src)
}
func (m *RunFixtureControl) XXX_Size() int {
	return xxx_messageInfo_RunFixtureControl.Size(m)
}
func (m *RunFixtureControl) XXX_DiscardUnknown() {
	xxx_messageInfo_RunFixtureControl.DiscardUnknown(m)
}

var xxx_messageInfo_RunFixtureControl proto.InternalMessageInfo

type isRunFixtureControl_Control interface {
	isRunFixtureControl_Control()
}

type RunFixtureControl_Log struct {
	Log string `protobuf:"bytes,1,opt,name=log,proto3,oneof"`
}

type RunFixtureControl_Error struct {
	Error *RunFixtureError `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
}

func (*RunFixtureControl_Log) isRunFixtureControl_Control() {}

func (*RunFixtureControl_Error) isRunFixtureControl_Control() {}

func (m *RunFixtureControl) GetControl() isRunFixtureControl_Control {
	if m != nil {
		return m.Control
	}
	return nil
...
func (m *RunFixtureControl) GetLog() string {
	if x, ok := m.GetControl().(*RunFixtureControl_Log); ok {
		return x.Log
	}
	return ""
}

func (m *RunFixtureControl) GetError() *RunFixtureError {
	if x, ok := m.GetControl().(*RunFixtureControl_Error); ok {
		return x.Error
	}
	return nil
}
...
func (*RunFixtureControl) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*RunFixtureControl_Log)(nil),
		(*RunFixtureControl_Error)(nil),
	}
}

// RunFixtureResponse is the control message the server streams to the caller.
type RunFixtureResponse struct {
	// Control is the main message.
	Control *RunFixtureControl `protobuf:"bytes,1,opt,name=control,proto3" json:"control,omitempty"`
...
func (m *RunFixtureResponse) GetControl() *RunFixtureControl {
	if m != nil {
		return m.Control
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RunFixtureControl)(nil), "tast.core.RunFixtureControl")
...
var fileDescriptor_5cb9905fdd848d3a = []byte{
	...
	,
}
